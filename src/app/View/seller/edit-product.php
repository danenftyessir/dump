...
<head>
    ...
    <link rel="stylesheet" href="/css/seller-product-form.css">
...
<body>
                    ...
                    <div class="form-group">
                        ...
                        <div class="upload-area" id="uploadArea">
                            ...
                            <?php if (!empty($product['main_image_path'])): ?>
                                <!-- show current image -->
                                <div class="image-preview" id="imagePreview" style="display: flex;">
    ...
    <script src="/js/seller-product-edit.js"></script>
</body>
</html>