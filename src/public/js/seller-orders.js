...
function renderOrderDetail(order) {
    ...
    if (order.status === 'rejected' && order.reject_reason) {
        rejectReasonHTML = `
            <div class="detail-row">
                ...
                <span class="detail-value" style="color: #e74c3c;">${escapeHtml(order.reject_reason)}</span>
            </div>
        `;
    }
    ...
    content.innerHTML = `
        <div class="order-detail-grid">
            ...
            <div class="detail-section">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value" style="text-align: left; margin-left: auto; max-width: 60%;">
        ...
        <div class="detail-section">
            ...
            <div class="detail-row" style="border-top: 2px solid #e8eaed; padding-top: 16px; margin-top: 16px;">
                <span class="detail-label" style="font-size: 1rem; font-weight: 700;">Total:</span>
                <span class="detail-value" style="font-size: 1.25rem; color: #42b549;">
...
function approveOrder(orderId) {
    ...
    content.innerHTML = `
        <div class="detail-section">
            ...
            <p style="margin-bottom: 20px; color: #6d7588;">Masukkan estimasi waktu pengiriman untuk pesanan ini:</p>
            ...
            <div class="input-group">
                ...
                <small style="color: #6d7588; margin-top: 4px; display: block;">
...
function showRejectForm(orderId) {
    ...
    content.innerHTML = `
        <div class="detail-section">
            ...
            <p style="margin-bottom: 20px; color: #6d7588;">Berikan alasan penolakan pesanan ini:</p>
...
function showError(message) {
    ...
    content.innerHTML = `
        <div class="empty-state">
            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: #e74c3c; margin-bottom: 16px;">
                <circle cx="12" cy="12" r="10"/>
